...
<table id="myTable-trans" class="table table-bordered table-hover" cellspacing="0">
    ...
    <tbody>
		...
		$sn=0;
		$query=mysqli_query($dbcon,"select * from case_table where CBI='$session_id'");
		...
		<a data-placement="left" title="Click to Edit" id="edit<?php echo $id; ?>" href="CBIstatement.php <?php echo '?edit='.$id; ?>" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
