	...
	<div class="col-md-8">
		<ul class="list-group" id="myinfo" >
			...
			<div class="panel-body">
			 ...
			 <div class="container-fluid">
					<form class="form-horizontal" action="saveCBIstatement.php" method="post" role="form">
...
<div class="col-md-6">
					  ...
					  <div class="form-group">
					  <button  type="submit" name="saveCBIstatement" class="btn btn-success form-control">Save
