...
<div class="container-fluid">
	...
	<div class="col-md-8">
		...
		<a href="assigncase.php<?php echo '?caseid='.$get_id; ?>"  class="btn btn-info" style="margin-bottom:20px"><i class="icon-print icon-large"></i> <?php if($status=='' or $status=='Not Yet' ){echo 'Assign This Case to CBI Officer';} else{echo 'Change CBI Officer';}?></a>
		</script>
